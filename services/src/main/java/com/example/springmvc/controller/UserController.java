...
import com.example.springmvc.repos.GalleryRepos;
...
public class UserController {
    ...
    public String user(@AuthenticationPrincipal User currentUser,
        ...
        boolean isSubscriber = account.getSubscribers().contains(currentUser);
    ...
    @GetMapping("/new/gallery")
    public String createGalleryTest(@AuthenticationPrincipal User user){
        userService.testCreateGallery(user);
