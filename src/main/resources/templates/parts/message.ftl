...
<#assign tags =[]>
<p>
    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThink" aria-expanded="false" aria-controls="collapseThink">
        Поділитись думкою.
    </button>
</p>
            ...
            <div class="container mx-auto">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mt-3">
                            <p>
                               <a data-bs-toggle="collapse" href="#collapseAddFile" role="button" aria-expanded="false" aria-controls="collapseAddFile">
                    ...
                    <p>
                        <a class="" data-bs-toggle="collapse" href="#collapseAddTag" role="button" aria-expanded="false" aria-controls="collapseAddTag">
